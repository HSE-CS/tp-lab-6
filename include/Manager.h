...
class ProjectManager : public Heading, public ProjectBudget {
 private:
    ...
    float part;
 public:
    ProjectManager(int id, std::string name, pos post, std::vector<Project *> myProject, float part, int salary)
            : Employee(id, name, post, salary), projects(std::move(myProject)), part(part) {}
...
class SeniorManager : public ProjectManager {
 private:
    ...
    float part;
 public:
    SeniorManager(int id, std::string name, pos post, std::vector<Project *> projects, float part, int salary)
               : ProjectManager(id, name, post, std::move(projects), part, salary),
  void calc() override;
}
