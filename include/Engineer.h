...
class Engineer : public ProjectBudget, public Personal {
 ...
 public:
    Engineer(int id, std::string name, pos post, int salary, Project *myProject, float part)
          : Personal(id, name, post, salary), myProject(myProject), part(part) {}
...
// private:
 public:
    Programmer(int id, std::string name, pos post, int salary, Project *myProject, float part)
...
// private:
 public:
    TeamLeader(int id, std::string name, pos post, int salary, Project *myProject, float part)
...
// private:
 public:
    Tester(int id, std::string name, pos post, int salary, Project *myProject, float part)
