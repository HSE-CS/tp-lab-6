...
TEST(Test_Employee, test_1) {
    Cleaner* person_test_1 = new Cleaner(78, "Barinov Danil",
        "Cleaner", 8, 456);
    EXPECT_EQ(78, person_test_1->getId());
}
TEST(Test_Employee, test_2) {
    Driver* person_test_2 = new Driver(76, "Buzanov Egor",
       "Driver", 6, 432);
    EXPECT_EQ("Buzanov Egor", person_test_2->getName());
}
TEST(Test_Employee, test_3) {
    Cleaner* person_test_3 = new Cleaner(78, "Barinov Danil",
      "Cleaner", 6, 436);
    EXPECT_EQ("Cleaner", person_test_3->getPosition());
}
TEST(Test_Employee, test_4) {
    Cleaner* person_test_4 = new Cleaner(78, "Barinov Danil",
      "Cleaner", 8, 456);
    EXPECT_EQ(8, person_test_4->getWorkTime());
}
TEST(Test_Employee, test_5) {
    Driver* person_test_5 = new Driver(76, "Buzanov Egor",
      "Driver", 6, 432);
    EXPECT_EQ(432, person_test_5->getPayment());
}
TEST(Test_Employee, test_6) {
    Driver* person_test_6 = new Driver(76, "Buzanov Egor",
      "Driver", 6, 432);
    person_test_6->setSalary(356);
    EXPECT_EQ(356, person_test_6->getSalary());
}
TEST(Test_Employee, test_7) {
    Driver* person_test_7 = new Driver(76, "Buzanov Egor",
      "Driver", 6, 432);
...
TEST(Test_Employee, test_8) {
    Driver* person_test_8 = new Driver(76, "Buzanov Egor",
       "Driver", 6, 432);
...
TEST(Test_Employee, test_12) {
    ...
    ProjectManager* person_test_12 = new ProjectManager(
         2, "Kolinin Alex", "Project Manager", 1, 8, 12234, projects);
...
TEST(Test_Employee, test_13) {
    ...
    ProjectManager* person_test_13 = new ProjectManager(
         2, "Kolinin Alex", "Project Manager", 2, 8, 12234, projects);
...
TEST(Test_Employee, test_15) {
    ...
    ProjectManager* person_test_15 = new ProjectManager(
         2, "Kolinin Alex", "Project Manager", 4, 8, 12234, projects);
