...
TEST(TestStaff, Test1) {
    ...
    Employee* emp = new Engineer("0004896ET2",
        "Evan Tate", "Engineer", 1550, pr);
    EXPECT_EQ("Engineer", emp->getPosition());
}

TEST(TestStaff, Test2) {
    Employee* emp = new Cleaner("0004896AW2",
        "Adele Wilkinson", "Cleaner", 550);
...
TEST(TestStaff, Test4) {
    ...
    Employee* emp = new ProjectManager("0004896ET2",
        "Evan Tate", "ProjectManager", projects);
...
TEST(TestStaff, Test5) {
    ...
    std::vector<Project> projects;
    projects.push_back(pr);
    Employee* emp = new SeniorManager("0004896ET2",
        "Evan Tate", "SeniorManager", projects);
    emp->setWorkTime(20);
    emp->calc();
...
TEST(TestStaff, Test6) {
    Driver* emp = new Driver("0001300ME2",
        "Marilyn Ellis", "Driver", 1200);
    emp->setWorkTime(30);
...
TEST(TestStaff, Test8) {
    ...
    Tester* emp = new Tester("0001300ME2",
        "Marilyn Ellis", "Tester", 1200, pr);
    emp->setWorkTime(30);
    emp->calc();
...
TEST(TestStaff, Test9) {
    ...
    ProjectManager* emp = new ProjectManager("0004896ET2",
        "Evan Tate", "ProjectManager", projects);
    emp->setWorkTime(30);
    emp->calc();
...
TEST(TestStaff, Test11) {
    ...
    TeamLeader* emp = new TeamLeader("0004896ET2",
        "Evan Tate", "TeamLeader", 2000, pr);
    emp->setWorkTime(30);
    emp->calc();
...
TEST(TestStaff, Test12) {
    ...
    projects.push_back(pr1);
    projects.push_back(pr2);
    SeniorManager* emp = new SeniorManager("0004896ET2", "Evan Tate",
        "SeniorManager", projects);
    emp->setWorkTime(20);
    emp->calc();
...
TEST(TestStaff, Test13) {
    Cleaner* emp = new Cleaner("0004896AW2",
        "Adele Wilkinson", "Cleaner", 550);
    emp->setWorkTime(25);
...
TEST(TestStaff, Test14) {
    Project pr = { "Online banking", 230490 };
    Engineer* emp = new Engineer("0004896ET2",
        "Evan Tate", "Engineer", 1550, pr);
    emp->setWorkTime(25);
...
TEST(TestStaff, Test15) {
    Project pr = { "Online banking", 230490 };
    Programmer* emp = new Programmer("0004896ET2",
        "Evan Tate", "Programmer", 1550, pr);
    emp->setWorkTime(25);
