...
TEST(Test_Employee, test_1) {
	Cleaner* person_test_1 = new Cleaner(78, "Vitalyi Petrovish", "Cleaner", 8, 456);
	EXPECT_EQ(78, person_test_1->getId());
}
TEST(Test_Employee, test_2) {
	Driver* person_test_2 = new Driver(76, "Alexandr Robertovish", "Driver", 6, 432);
	EXPECT_EQ("Alexandr Robertovish", person_test_2->getName());
}
TEST(Test_Employee, test_3) {
	Cleaner* person_test_3 = new Cleaner(78, "Vitalyi Petrovish", "Cleaner", 6, 436);
	EXPECT_EQ("Cleaner", person_test_2->getPosition());
}
TEST(Test_Employee, test_4) {
	Cleaner* person_test_4 = new Cleaner(78, "Vitalyi Petrovish", "Cleaner", 8, 456);
	EXPECT_EQ(8, person_test_4->getWorkTime());
}
TEST(Test_Employee, test_5) {
	Driver* person_test_5 = new Driver(76, "Alexandr Robertovish", "Driver", 6, 432);
	EXPECT_EQ(432, person_test_5->getPayment());
}
TEST(Test_Employee, test_6) {
	Driver* person_test_6 = new Driver(76, "Alexandr Robertovish", "Driver", 6, 432);
	person_test_6->setSalary(356);
	EXPECT_EQ(356, person_test_6->getSalary());
}
TEST(Test_Employee, test_7) {
	Driver* person_test_7 = new Driver(76, "Alexandr Robertovish", "Driver", 6, 432);
...
TEST(Test_Employee, test_8) {
	Driver* person_test_8 = new Driver(76, "Alexandr Robertovish", "Driver", 6, 432);
	person_test_8->setSalary(35);
	person_test_8->calcBase(person_test_8->getSalary(), person_test_8->getWorkTime());
