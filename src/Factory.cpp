        ...
        while(file.good()) {
            ...
            if (type == "project") {
                ...
                if(position == "programmer") {
                    ...
                    employee.push_back(new Programmer(stoi(id), name, stoi(workTime),
                                                      PROGRAMMER, stoi(salary),
                    ...
                    employee.push_back(new TeamLeader(stoi(id), name, stoi(workTime),
                                                      TEAM_LEADER, stoi(salary),
                                                      getProject(stoi(projectId), projects)));
                    ...
                    employee.push_back(new Engineer(stoi(id), name, stoi(workTime),
                                                    ENGINEER, stoi(salary),
                                                    getProject(stoi(projectId), projects)));
                    ...
                    employee.push_back(new Tester(stoi(id), name, stoi(workTime),
                                                  TESTER, stoi(salary),
                                                  getProject(stoi(projectId), projects)));
                } else if(position == "personal") {
                    getline(file, salary, ';');
                    employee.push_back(new Personal(stoi(id), name, stoi(workTime),
                                                    PERSONAL, stoi(salary)));
                } else if(position == "cleaner") {
                    getline(file, salary, ';');
                    employee.push_back(new Cleaner(stoi(id), name, stoi(workTime),
                                                   CLEANER, stoi(salary)));
                } else if(position == "driver") {
                    std::string bonus;
                    getline(file, salary, ';');
                    getline(file, bonus, ';');
                    employee.push_back(new Driver(stoi(id), name, stoi(workTime),
                                                  DRIVER, stoi(salary), stod(bonus)));
...
Project *StaffFactory::getProject(int id, std::vector<Project *> &projects) {
