...
void Employee::printInfo() {
  ...
  switch (this->position) {
    case Position::Cleaner:
      std::cout << std::setw(setw1) << "|Position " << std::setw(setw2) << "Cleaner"
                << " |" << std::endl;
      break;
    case Position::Driver:
      std::cout << std::setw(setw1) << "|Position " << std::setw(setw2) << "Driver"
                << " |" << std::endl;
      break;
    ...
    case Position::ProjectManager:
      std::cout << std::setw(setw1) << "|Position " << std::setw(setw2)
                << "ProjectManager" << " |" << std::endl;
      break;
    case Position::SeniorManager:
      std::cout << std::setw(setw1) << "|Position " << std::setw(setw2)
                << "SeniorManager " << " |" << std::endl;
      break;
    ...
    case Position::Tester:
      std::cout << std::setw(setw1) << "|Position " << std::setw(setw2) << "Tester"
                << " |" << std::endl;
      break;
  }
  std::cout << std::setw(setw1) << "|WorkTime " << std::setw(setw2) << this->worktime << " |"
            << std::endl;
  std::cout << std::setw(setw1) << "|Payment " << std::setw(setw2) << this->payment << " |"
            << std::endl;
}
