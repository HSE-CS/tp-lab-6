...
Engineer::Engineer(int budget1, std::string projectName1, std::string name1, int worktime1, Project *project1,
...
Programmer::Programmer(std::string name1,
                       ...
                       Project *project1,
                       int position1,
                       int salary1) : Engineer(0, std::__cxx11::string(), std::move(name1),
                                               worktime1,
                                               project1,
                                               position1,
                                               salary1) {
